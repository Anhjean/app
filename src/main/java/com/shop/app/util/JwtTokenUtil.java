...
import com.shop.app.modules.core.constant.JWTConstants;
...
public class JwtTokenUtil implements Serializable {
    ...
    private Claims getAllClaimsFromToken(String token) {
        ...
        return  Jwts.parserBuilder().setSigningKey(JWTConstants.SIGNING_KEY).build().parseClaimsJws(token).getBody();
    ...
    private String doGenerateToken(String subject, String tenantOrClientId) {
        ...
        return Jwts.builder()
                ...
                .signWith(JWTConstants.SIGNING_KEY)
                .compact();
        // return Jwts.builder()
        // .setClaims(claims)
        // .setIssuer("system")
